...
```
    ...
    ## ([<matplotlib.axis.YTick object at 0x0000000064172400>, <matplotlib.axis.YTick object at 0x0000000064154080>, <matplotlib.axis.YTick object at 0x00000000641FE320>], <a list of 3 Text yticklabel objects>)
...
The final clustered data set can be further analysed with descriptive statisticals methods, but I will stop here. I hope this mini project was informative and showed the correct way in clustering.
